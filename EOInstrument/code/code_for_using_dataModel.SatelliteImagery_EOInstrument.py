...
dataModel = "EOInstrument"
subject = "dataModel.SatelliteImagery"
carriedOn = "{'type': 'Relationship', 'object': 'urn:ngsi-ld:EOSatellitePlatform:154'}"
attribute = "carriedOn"
value = carriedOn
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

instrumentID = "{'type': 'Property', 'value': 'SAR-C'}"
attribute = "instrumentID"
value = instrumentID
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

instrumentName = "{'type': 'Property', 'value': 'Synthetic Aperture Radar (C-band)'}"
attribute = "instrumentName"
value = instrumentName
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

operationalMode = "{'type': 'Property', 'value': 'IW'}"
