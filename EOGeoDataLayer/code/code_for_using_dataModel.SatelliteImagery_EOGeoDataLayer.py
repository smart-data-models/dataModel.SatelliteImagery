...
dataModel = "EOGeoDataLayer"
subject = "dataModel.SatelliteImagery"
contentInformation = [{'layer_name': 'band1', 'layer_categorization': 'categorical', 'values_explanation': ['1:oil', '0:water']}]
