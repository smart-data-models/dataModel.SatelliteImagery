...
dataModel = "EOSatellitePlatform"
subject = "dataModel.SatelliteImagery"
platformID = "{'type': 'Property', 'value': 'B'}"
attribute = "platformID"
value = platformID
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

platformNSSDCA = "{'type': 'Property', 'value': '2016-025A'}"
attribute = "platformNSSDCA"
value = platformNSSDCA
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

platformName = "{'type': 'Property', 'value': 'Sentinel-1'}"
